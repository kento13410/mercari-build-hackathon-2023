...
# {"id":21}
$ curl -X POST --url 'http://127.0.0.1:9000/items' -F 'name=item' -F 'category_id=1' -F 'price=100' -F 'description=samplesamplesample' -F 'image=@images/NIKI.jpg' -H "Authorization: Bearer "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoxLCJleHAiOjE2ODUxODQ5MzR9.T6zdUKdnxCgrTfptml6MAtyHL3Bgeu__RzqmusyET58""
# Item list
